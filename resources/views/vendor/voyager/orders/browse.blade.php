        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe id="modal-iframe" src="" frameborder="0" style="width: 100%; height: 500px;"></iframe>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.open-modal-button').click(function() {
                ...
                var iframeSrc = "{{ route('wave.payment', ':itemId') }}";
                iframeSrc = iframeSrc.replace(':itemId', itemId);
                
                // Clear the iframe source before setting a new one
                $('#modal-iframe').attr('src', 'about:blank');
                
                $('#modal-item-id').text(itemId); // Update modal content with the id
